...
grails.project.groupId = "mx.jhcue.${appName}"
...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'mx.jhcue.edlm.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'mx.jhcue.edlm.UserAuthorities'
grails.plugin.springsecurity.authority.className = 'mx.jhcue.edlm.Authorities'
